...
public class Servicio_RecognitionListener extends Service implements RecognitionListener {
    ...
    public class LocalBinder extends Binder {
        Servicio_RecognitionListener.Servicio_RecognitionListener getService() {
            return Servicio_RecognitionListener.Servicio_RecognitionListener.this;
        }
    }
    ...
    private static class SetupSpeechTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<Servicio_RecognitionListener.Servicio_RecognitionListener> activityReference;

        SetupSpeechTask(Servicio_RecognitionListener.Servicio_RecognitionListener activity) {
    ...
    private class MailBuilder extends AsyncTask<Void, Void, Void> {
        ...
        MailBuilder(Servicio_RecognitionListener.Servicio_RecognitionListener activity) {
            this.activityReference = new WeakReference<>(activity);
        }
